    ...
    <div style={pokedexStyles}>
      ...
      <div style={{
        ...
        >
          ...
          >
            {selected && (
              <div style={{width: '100%', display: 'flex', flexDirection: 'row', gap: '1.2rem', alignItems: 'flex-start', justifyContent: 'center'}}>
                <div style={{flex: 1, display: 'flex', flexDirection: 'row', gap: '1.2rem'}}>
                  <div style={{flex: 1}}>
                    <h2 style={{margin: '0 0 0.15rem 0', color: 'var(--pokedex-red)', fontWeight: 900, fontSize: '1.08rem', letterSpacing: '0.01em'}}>{selected.name}</h2>
                    <h4 style={{margin: '0 0 0.4rem 0', color: '#616161', fontWeight: 500, fontStyle: 'italic', fontSize: '0.92rem', letterSpacing: '0.01em'}}>{selected.scientific_name}</h4>
                    <p style={{margin: '0 0 0.4rem 0', color: '#333', fontSize: '0.88rem', textAlign: 'left', lineHeight: 1.3}}>{selected.description}</p>
                  </div>
                  <div style={{flex: 1}}>
                    <table style={{width: '100%', fontSize: '0.88rem', color: '#444', marginBottom: 0, borderSpacing: 0}}>
                      <tbody>
                        <tr><td style={{fontWeight: 600, padding: '0.15rem 0.3rem 0.15rem 0', whiteSpace: 'nowrap'}}>Kingdom:</td><td style={{padding: '0.15rem 0'}}>{selected.kingdom}</td></tr>
                        <tr><td style={{fontWeight: 600, padding: '0.15rem 0.3rem 0.15rem 0', whiteSpace: 'nowrap'}}>Classification:</td><td style={{padding: '0.15rem 0'}}>{selected.classification}</td></tr>
                        <tr><td style={{fontWeight: 600, padding: '0.15rem 0.3rem 0.15rem 0', whiteSpace: 'nowrap'}}>Family:</td><td style={{padding: '0.15rem 0'}}>{selected.family}</td></tr>
                        <tr>
                        ...
                        <tr><td style={{fontWeight: 600, padding: '0.15rem 0.3rem 0.15rem 0', whiteSpace: 'nowrap'}}>Height:</td><td style={{padding: '0.15rem 0'}}>{selected.height} m</td></tr>
                        <tr><td style={{fontWeight: 600, padding: '0.15rem 0.3rem 0.15rem 0', whiteSpace: 'nowrap'}}>Weight:</td><td style={{padding: '0.15rem 0'}}>{selected.weight} kg</td></tr>
                      </tbody>
                    </table>
                  </div>
                </div>
